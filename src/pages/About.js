    ...
    <>
      <Container maxW={'1500px'} mt={12} mb={10} fontFamily={'monospace'}>
        <Grid templateColumns={['repeat(1, 1fr)', 'repeat(1, 1fr)', 'repeat(2, 1fr)']} gap={6}>
          <GridItem w='100%'  >
            <Image src={about} w={'100%'} borderRadius={'20px'} />
          </GridItem>
          <GridItem w='100%' fontSize={['1.25rem']} ml={3}>
            ...
            <Text mt={8}>
              Launced in 2015, Brandy is Asia’s premier online shopping makterplace with an active presense in India. Supported by wide range of tailored marketing, data and service solutions, Brandy has 10,500 sallers and 300 brands and serves 3 millioons customers across the region.
            </Text>

            <Text>Brandy has more than 1 Million products to offer, growing at a very fast. Brandy offers a diverse assotment in categories ranging  from consumer.</Text>
          </GridItem>
        </Grid>
