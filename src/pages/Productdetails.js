import { Container, HStack, Image, Stack, VStack, Text, Button, useMediaQuery, Grid, GridItem, Box, Heading } from '@chakra-ui/react'
      ...
      <Container maxW={['container.sm', 'container.lg', 'container']} h={['1200', '1200', '900']} mb={20}>
        ...
        <Grid templateColumns={['repeat(1, 1fr)', 'repeat(1, 1fr)', 'repeat(2, 1fr)']} mt={12} gap={6}>
          <GridItem w='100%' h='370' >
            ...
            <Grid templateColumns='repeat(4, 1fr)' gap={0} mt={8}>

              <GridItem w={20} h='10' >
                <Image src={products?.images?.[0]} h={70} w={70}></Image>
              </GridItem>

              <GridItem w='20' h='10'>
                <Image src={products?.images?.[1]} h={70} w={70}></Image>
              </GridItem>

              <GridItem w='20' h='10' >
                <Image src={products?.images?.[2]} h={70} w={70}></Image>
              </GridItem>

              <GridItem w='20' h='10'>
                <Image src={products?.images?.[3]} h={70} w={70}></Image>
              </GridItem>
          ...
          <GridItem w='100%' h='400' mt={['2', '10', '12']}>
            <Stack>
              ...
              <Text fontFamily={'monospace'} fontSize={'1.5rem'} mt={0} >${products.price}.00  <Text fontSize={'1rem'} color={'#00FF66'}>In Stock-{products.stock}</Text>
          ...
          <GridItem w='100%' h='10' mt={16}>
            <Box>
              <HStack>
                ...
                <Text mt={10} ml={5} fontSize={'1rem'}>Free Delivey <br /> Enter your postal code for Delivey Availability </Text>
              </HStack>
            </Box>
